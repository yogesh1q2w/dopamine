...
class OutOfGraphPrioritizedReplayBuffer(circular_replay_buffer.OutOfGraphReplayBuffer):
    ...
    def get_add_args_signature(self):
        ...
        Returns:
          list of ReplayElements defining the type of the argument signature needed
            by the add function.
        """
        parent_add_signature = super(OutOfGraphPrioritizedReplayBuffer, self).get_add_args_signature()
    ...
    def sample_transition_batch(self, batch_size=None, indices=None):
        ...
        """
        transition = super(OutOfGraphPrioritizedReplayBuffer, self).sample_transition_batch(batch_size, indices)
    ...
    def get_transition_elements(self, batch_size=None):
        ...
        """
        parent_transition_type = super(OutOfGraphPrioritizedReplayBuffer, self).get_transition_elements(batch_size)
