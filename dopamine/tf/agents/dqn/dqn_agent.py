...
class DQNAgent(object):
    ...
    def __init__(
        ...
        with tf.device(tf_device):
            ...
            self.state_ph = tf.compat.v1.placeholder(self.observation_dtype, state_shape, name="state_ph")
        ...
        self._saver = tf.compat.v1.train.Saver(var_list=var_map, max_to_keep=max_tf_checkpoints_to_keep)
    ...
    def _build_train_op(self):
        ...
        """
        replay_action_one_hot = tf.one_hot(self._replay.actions, self.num_actions, 1.0, 0.0, name="action_one_hot")
