...
jax.tree_util.register_pytree_node(MoELossParameters, loss_params_flatten, loss_params_unflatten)
...
jax.tree_util.register_pytree_node(MoELossStatistic, loss_stat_flatten, loss_stat_unflatten)
...
jax.tree_util.register_pytree_node(MoELossReturn, loss_return_flatten, loss_return_unflatten)
