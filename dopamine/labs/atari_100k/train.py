...
def main(unused_argv):
    ...
    create_agent_fn = functools.partial(create_agent, seed=FLAGS.run_number, agent_name=FLAGS.agent)
    if FLAGS.legacy_runner:
        ...
        runner = atari_100k_runner.DataEfficientAtariRunner(base_dir, create_agent_fn)
