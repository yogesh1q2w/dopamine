...
class WrappedNetworkDef(object):
    ...
    def set_return_to_condition(self, return_multiplier=1.0):
        return_to_condition = (self._max_return - self._min_return) * return_multiplier + self._max_return
        self._return_to_condition = jnp.array(return_to_condition, dtype=jnp.float32)
...
class JaxReturnConditionedBCAgent(offline_rainbow_agent.OfflineJaxRainbowAgent):
    ...
    def __init__(self, num_actions, replay_data_dir, summary_writer=None, use_tfds=True):
    ...
    def _create_wrapped_network(self):
        ...
        self.wrapped_network_def = WrappedNetworkDef(self.network_def, min_return, max_return)
