...
flags.DEFINE_string("replay_dir", None, "Directory from which to load the replay data")
flags.DEFINE_string(
    "replay_dir_suffix",
    "replay_logs",
...
def create_offline_agent(sess, environment, agent_name, replay_data_dir, summary_writer=None):
