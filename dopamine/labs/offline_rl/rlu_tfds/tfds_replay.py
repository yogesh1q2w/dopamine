...
def get_atari_ds_name_from_replay(path: str, tfds_dataset: str = "rlu_atari_checkpoints_ordered") -> str:
    ...
    def __init__(
        ...
        **unused_kwargs,
        ...
        if dataset_expertise is not None:
            ...
            dataset = tfds_atari_utils.uniformly_subsampled_atari_data(dataset_name, self._data_percent)
