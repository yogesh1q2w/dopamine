...
@gin.configurable
def create_minatar_env(game_name, sticky_actions=False, action_repeat_probability=0.25, seed=None):
...
class MinatarDQNNetwork(nn.Module):
    ...
    def __call__(self, x: jnp.ndarray) -> jnp.ndarray:
        ...
        x = nn.Conv(features=16, kernel_size=(3, 3), strides=(1, 1), kernel_init=initializer)(x)
        x = nn.relu(x)
