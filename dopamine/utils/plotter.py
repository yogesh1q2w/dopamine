...
class Plotter(object):
    ...
    def _setup_plot(self):
        ...
        if "xlabel" in self.parameters:
            self.plot.set_xlabel(self.parameters["xlabel"], fontsize=self.parameters["fontsize"] - 2)
        if "ylabel" in self.parameters:
            self.plot.set_ylabel(self.parameters["ylabel"], fontsize=self.parameters["fontsize"] - 2)
        if "title" in self.parameters:
            self.plot.set_title(self.parameters["title"], fontsize=self.parameters["fontsize"] + 2)
