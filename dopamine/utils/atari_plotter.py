...
class AtariPlotter(plotter.Plotter):
    ...
    def __init__(self, parameter_dict=None):
        ...
        self.game_surface = pygame.Surface((self.parameters["input_width"], self.parameters["input_height"]))
    ...
    def draw(self):
        ...
        return pygame.transform.scale(self.game_surface, (self.parameters["width"], self.parameters["height"]))
