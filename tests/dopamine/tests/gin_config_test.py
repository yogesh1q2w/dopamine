...
class GinConfigTest(tf.test.TestCase):
    ...
    def testDefaultGinDqn(self):
        ...
        self.assertIsInstance(runner._agent.optimizer, optax._src.base.GradientTransformationExtraArgs)
    ...
    def testDefaultGinRainbow(self):
        ...
        gin_files = ["dopamine/jax/agents/rainbow/configs/rainbow.gin"]
        gin_bindings = [
            "ReplayBuffer.max_capacity = 100",  # To prevent OOM.
    ...
    def testDefaultDQNConfig(self):
        ...
        run_experiment.load_gin_configs(["dopamine/jax/agents/dqn/configs/dqn.gin"], [])
        agent = run_experiment.create_agent(None, atari_lib.create_atari_environment(game_name="Pong"))
    ...
    def testDefaultC51Config(self):
        ...
        run_experiment.load_gin_configs(["dopamine/jax/agents/rainbow/configs/c51.gin"], [])
        agent = run_experiment.create_agent(None, atari_lib.create_atari_environment(game_name="Pong"))
    ...
    def testDefaultRainbowConfig(self):
        ...
        run_experiment.load_gin_configs(["dopamine/jax/agents/rainbow/configs/rainbow.gin"], [])
        agent = run_experiment.create_agent(None, atari_lib.create_atari_environment(game_name="Pong"))
        self.assertEqual(agent._num_atoms, 51)
        support = agent._support
        self.assertEqual(min(support), -10.0)
    ...
    def testDefaultGinImplicitQuantile(self):
        ...
        gin_files = ["dopamine/jax/agents/" + "implicit_quantile/configs/implicit_quantile.gin"]
        gin_bindings = [
